...
model_folder = 'AE_4_200_100_3_100_200_4'
train_folder = 'AE_bn_LeakyReLU_bs8192_lr1e-02_wd1e-04_ppNA'
...
data = torch.tensor(test[idxs[0]:idxs[1]].values)
pred = utils.logunnormalized_reconstructions(learn.model, test[idxs[0]:idxs[1]])
