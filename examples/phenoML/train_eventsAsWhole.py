...
# train = pd.read_pickle('/home/honey/cern/July/datasets/njets_train.pkl')
# test = pd.read_pickle('/home/honey/cern/July/datasets/njets_test.pkl')
...
def one_run(module, epochs, lr, wd, pp, ct, dim):
    ...
    if pp is not None:
        ...
        curr_model = module([dim, 400, 400, 200, dim // 2, 200, 400, 400, dim])
