...
train = pd.read_pickle('/afs/cern.ch/work/h/hgupta/public/phenoML/processed_4D_njets_small_4D_train.pkl')
test = pd.read_pickle('/afs/cern.ch/work/h/hgupta/public/phenoML/processed_4D_njets_small_4D_test.pkl')

# Basic pre-processing
#train = train.drop(columns='njets')
#test = test.drop(columns='njets')

# Halfen the training data
