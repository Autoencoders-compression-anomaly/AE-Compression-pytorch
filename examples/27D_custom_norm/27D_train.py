...
train = pd.read_pickle(BIN + 'datasets/processed_data/aod/custom_normalized_train.pkl')
test = pd.read_pickle(BIN + 'datasets/processed_data/aod/custom_normalized_test.pkl')
...
checkpoint_name = 'nn_utils_bs8192_lr1e-04_wd1e-02_ppNA'
